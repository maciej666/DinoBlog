...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'pipi_notification' => 'getPipiNotificationService',
            ...
            'security.firewall.map.context.blog_admin' => 'getSecurity_Firewall_Map_Context_BlogAdminService',
            ...
            'security.user_checker.blog_admin' => 'getSecurity_UserChecker_BlogAdminService',
        ...
        $this->aliases = array(
            ...
            'security.user_checker.main' => 'security.user_checker.blog_admin',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'pipi666', 'user' => 'root', 'password' => 'karo666', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/PipiTrainingBundle/Entity'))), 'PipiTrainingBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('PipiTrainingBundle' => 'PipiTrainingBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_3c8280299e8eac32a2cc2085cbf5300b06e1ab070f84ded3bf2b9b6095cfd8da');
    ...
    /**
     * Gets the 'pipi_notification' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PipiTrainingBundle\Service\NotificationService A PipiTrainingBundle\Service\NotificationService instance.
     */
    protected function getPipiNotificationService()
    {
        return $this->services['pipi_notification'] = new \PipiTrainingBundle\Service\NotificationService($this->get('session'));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.blog_admin' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/blog/admin'), 'security.firewall.map.context.main' => NULL)), $this->get('debug.event_dispatcher'));
    }

    /**
     * Gets the 'security.firewall.map.context.blog_admin' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_Firewall_Map_Context_BlogAdminService()
    {
        $a = $this->get('security.token_storage');
        $b = $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE);

        $c = new \Symfony\Component\Security\Http\EntryPoint\BasicAuthenticationEntryPoint('Pipi Admin Panel');

        return $this->services['security.firewall.map.context.blog_admin'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'blog_admin', $b, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($a, $this->get('security.authentication.manager'), 'blog_admin', $c, $b), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'blog_admin', $c, NULL, NULL, $b, false));
    }
    ...
    /**
     * Gets the 'security.user_checker.blog_admin' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_UserChecker_BlogAdminService()
    {
        return $this->services['security.user_checker.blog_admin'] = new \Symfony\Component\Security\Core\User\UserChecker();
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('boban.kamienczuk@gmail.com');
        $a->setPassword('Karolina666');
        $a->setAuthMode('login');
    ...
    protected function getTemplating_Engine_TwigService()
    {
        ...
        return $this->services['templating.engine.twig'] = new \Elao\WebProfilerExtraBundle\TwigProfilerEngine($a, new \Symfony\Bundle\TwigBundle\TwigEngine($a, $this->get('templating.name_parser'), $this->get('templating.locator')), $this->get('web_profiler_extra.data_collector.twig'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'PipiTrainingBundle:Form:form_theme.html.twig'), 'autoescape' => 'filename', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'PipiTrainingBundle:Form:form_theme.html.twig')), $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Twig_Extension_Debug());
        $instance->addExtension(new \Doctrine\Bundle\DoctrineBundle\Twig\DoctrineExtension());
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\DumpExtension($this->get('var_dumper.cloner')));
        $instance->addExtension(new \Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension());
        $instance->addGlobal('app', $f);
        $instance->addGlobal('meta_description', 'Z pamiętnika domorosłego inwestora');
        $instance->addGlobal('meta_author', 'Janek Złotówka');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[2].'/Resources/PipiTrainingBundle/views'), 'PipiTraining');
        $instance->addPath(($this->targetDirs[3].'/src/PipiTrainingBundle/Resources/views'), 'PipiTraining');
        $instance->addPath(($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/views'), 'Debug');
        $instance->addPath(($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views'), 'WebProfiler');
        $instance->addPath(($this->targetDirs[3].'/vendor/elao/web-profiler-extra-bundle/Resources/views'), 'WebProfilerExtra');
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/blog/admin/update|details'), array(0 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/blog/admin'), array(0 => 'ROLE_MODERATOR'), NULL);
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.in_memory'), $this->get('security.user_checker.blog_admin'), 'blog_admin', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56f057ab539029.23340982')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_MODERATOR' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_MODERATOR'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('user', 'karo666', array(0 => 'ROLE_USER')));
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('admin', 'karo666', array(0 => 'ROLE_ADMIN')));
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('mod', 'karo666', array(0 => 'ROLE_MODERATOR')));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PipiTrainingBundle' => 'PipiTrainingBundle\\PipiTrainingBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'pipi666',
            'database_user' => 'root',
            'database_password' => 'karo666',
            'mailer_transport' => 'gmail',
            'mailer_host' => NULL,
            'mailer_user' => 'boban.kamienczuk@gmail.com',
            'mailer_password' => 'Karolina666',
            ...
            'twig.form.resources' => array(
                ...
                1 => 'PipiTrainingBundle:Form:form_theme.html.twig',
            ),
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'boban.kamienczuk@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Karolina666',
